      ...
      <div className="relative hidden border-r border-border bg-card p-12 text-foreground lg:flex lg:flex-col lg:justify-between">
        ...
        <div>
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            A program by the ARC Alumni Trainee Cell.
          </p>
        </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-amber-500">
                        ⚠️ Note: Your branch cannot be changed after account creation. Choose
                        carefully.
                      </p>
                    </div>
            ...
            <Button
              type="submit"
              className="w-full"
              disabled={submitting || (mode === "signup" && role === "STUDENT" && !branch)}
            >
