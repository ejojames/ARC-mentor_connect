      ...
      <main className="mx-auto max-w-6xl px-6 py-24">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-xl text-base text-muted-foreground">
            ...
            track, and grow — across Web Dev, Electronics, Placements, Higher Studies, and
            Entrepreneurship.
          </p>
          <div className="mt-10 flex flex-wrap gap-3">
            ...
            <Link
              to="/auth"
              search={{ mode: "signin" }}
              className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-5 py-3 text-sm font-medium hover:bg-muted transition"
            >
              I have an account
            </Link>
          </div>
        ...
        <div className="mt-24 grid gap-6 sm:grid-cols-2">
          <Feature
            ...
            title="For Mentors"
            desc="Publish opportunities, screen statements of purpose, and accept the right candidates in one click."
          />
          <Feature
            icon={<Users className="h-5 w-5" />}
            title="For Students"
            desc="Discover programs by domain, submit a focused SOP, and track every application's status in real time."
          />
        </div>
      </main>
    </div>
