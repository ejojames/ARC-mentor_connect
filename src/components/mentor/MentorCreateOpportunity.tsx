  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6 sm:py-10">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Publish a new mentorship program for students to discover.
      </p>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            rows={5}
            placeholder="What will mentees gain? What does the program cover?"
            required
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            rows={3}
            placeholder="Who should apply? Prerequisites, year, GPA, prior experience…"
          />
        </div>
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Server-side trigger instantly accepts applicants who match your eligibility, up to
                  the cap.
                </p>
              </div>
            </div>
        ...
        <div className="rounded-lg bg-muted/50 px-4 py-3 text-xs text-muted-foreground">
          Status will be set to <span className="font-medium text-foreground">OPEN</span> by
          default.
        </div>
